...
/// A pure picker field widget without any form row wrapper.
/// Use this when you want to embed the picker in your own layout structure.
class AdaptivePickerField<T> extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    developer.log(
      'Building picker field for ${items.length} items, platform: ${UniversalPlatform.isApple ? "Apple" : "Other"}',
      name: 'AdaptivePickerField',
    );
